...
### [](#lesssuggestionmenu-greater)`<SuggestionMenu />`
...
Additional floating UI positioning options
...
Maximum height of the suggestion menu in pixels. Menu scrolls if content exceeds this height
...
Placeholder text in decoration

## [](#types)Types

### [](#suggestionitemlesstgreater)`SuggestionItem<T>`
...
### [](#suggestionmenurenderpropslesstgreater)`SuggestionMenuRenderProps<T>`
...
### [](#filtersuggestionitemsitems-query)`filterSuggestionItems(items, query)`
...
Array of suggestion items to filter
...
### [](#calculatestartpositioncursorposition-previousnode-triggerchar)`calculateStartPosition(cursorPosition, previousNode, triggerChar)`
...
Character that triggered suggestions

## [](#advanced-usage)Advanced Usage

### [](#custom-suggestion-menu)Custom Suggestion Menu
...
Maximum height of the menu, dynamically calculated
