    ...
    >
      ...
      >
        <div
          ...
          className="flex flex-col group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:rounded-lg w-full h-full"
        >
          {children}
        </div>
      </div>
